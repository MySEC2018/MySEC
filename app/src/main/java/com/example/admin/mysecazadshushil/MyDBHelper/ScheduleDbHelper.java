package com.example.admin.mysecazadshushil.MyDBHelper;
...
import com.example.admin.mysecazadshushil.DB.MyDB;
...
public class ScheduleDbHelper extends SQLiteOpenHelper {
    ...
    public ScheduleDbHelper(Context context) {
        super(context, MyDB.TABLE_NAME, null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + MyDB.TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, " +
    ...
    public boolean addData(String day, String item, String subject, String time) {
        ...
        long result = db.insert(MyDB.TABLE_NAME, null, contentValues);

        return result != -1;
    }

    public List<Schedule_model> getAll() {
        List<Schedule_model> schedules = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + MyDB.TABLE_NAME;
        ...
        while (cursor.moveToNext()) {
            ...
            Schedule_model schedule = new Schedule_model(id, day, item, subject, time);
    ...
    public boolean deleteById(String id) {
        SQLiteDatabase db = this.getReadableDatabase();
        return db.delete(MyDB.TABLE_NAME, "ID=?", new String[]{id}) > 0;
    }
    ...
    public boolean updateById(String id, String day, String item, String subject, String time) {
        ...
        contentValues.put(COL4, subject);
        contentValues.put(COL5, time);
        return db.update(MyDB.TABLE_NAME, contentValues, "ID=" + id, null) > 0;
    }
}
